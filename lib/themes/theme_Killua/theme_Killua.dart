...
class MaterialTheme {
  ...
  static ColorScheme lightScheme() {
    return const ColorScheme(
      ...
      onPrimaryContainer: Color(0xff364379),
      ...
      onPrimaryFixedVariant: Color(0xff364379),
  ...
  static ColorScheme darkScheme() {
    return const ColorScheme(
      ...
      primaryContainer: Color(0xff364379),
  ...
  static ColorScheme darkMediumContrastScheme() {
    return const ColorScheme(
      ...
      primaryFixed: Color(0xffdde1ff),
      onPrimaryFixed: Color(0xff000c3b),
      primaryFixedDim: Color(0xffb7c4ff),
  ...
  static ColorScheme darkHighContrastScheme() {
    return const ColorScheme(
      ...
      primaryFixedDim: Color(0xffb7c4ff),
      onPrimaryFixedVariant: Color(0xff000c3b),
      secondaryFixed: Color(0xffdee1f9),
